...
dogsplot <- dogs %>%
    ...
    labs(
        ...
        subtitle = "#TidyTuesday, RSPCA Australia, A day at the Races",
        x = NULL,y = NULL
    ) +
    scale_y_continuous(
        limits = c(0, 0.8),
...
dog.animation = dogsplot +
    transition_reveal(year) + 
    view_follow(fixed_y = TRUE)

animate(dog.animation, height = 200, width = 300, fps = 20, duration = 25,
        end_pause = 30, res = 20)
getwd()
anim_save("dogtotherescue.gif")
...
## brisbane_complaints <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesd#ay/master/data/2020/2020-07-21/brisbane_complaints.csv')
#
#
##tt %>% map(glimpse)
#
